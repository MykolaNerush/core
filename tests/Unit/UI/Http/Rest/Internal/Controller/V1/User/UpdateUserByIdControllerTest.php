...
namespace App\tests\Unit\UI\Http\Rest\Internal\Controller\V1\User;
...
{
    public function testCreateWithValidRequest(): void
    {
    ...
    public function testCreateWithMissingHandler(): void
    {
        $uuid = Uuid::uuid4()->toString();
        $request = new Request([], ['name' => 'John Doe', 'email' => 'johndoe@example.com', 'password' => 'securePassword']);
